    ...
    <div class="container">
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-4 col-md-6">
                <div class="team-member chef-projet">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="team-member">
                    ...
                    <div class="badge-chef">Développeuse Full-Stack</div>
<!--                    <p class="member-role">-->
...
<!--                    </p>-->
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="team-member">
                    ...
                    <div class="badge-chef">Développeuse Back-End</div>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="team-member">
                    ...
                    <div class="badge-chef">Chef de Projet <br> MOA</div>
                </div>
            </div>
